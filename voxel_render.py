...
colour_map_img = pg.image.load('img/color_map.jpg')
colour_map = pg.surfarray.array3d(colour_map_img)
        ...
        for depth in range(1, ray_distance):
            ...
            if 0 < x < map_width:
                ...
                if 0 < y < map_height:
                    ...
                    #Remove fisheye and get the height on the screen
                    ...
                    if height_on_screen < y_buffer[num_ray]:
                        for screen_y in range(height_on_screen, y_buffer[num_ray]):
                            screen_array[num_ray, screen_y] = colour_map[x, y]
